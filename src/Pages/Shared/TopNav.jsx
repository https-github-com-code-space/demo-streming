...
const TopNav = () => {
  return (
<div>
      <nav className="bg-white text-[#4b69bd] hidden md:block py-1">
        <div className="md:px-16 lg:px-20">
          <div className="flex justify-between align-center" >
            <ul className="flex space-x-3">
              <li className=" ">
                <a href="tel:(+10) 123 456 " className=" flex " >
            ...
            <a href="mailto:companymail@gmail.com" className="flex justify-center items-center text-decoration-none list-hover" >
